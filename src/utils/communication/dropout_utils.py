...
class NodeDropout:
    ...
    def __init__(self, node_id: int, dropout_dict: dict, rng: random.Random) -> None:
        ...
        self.dropout_rate = dropout_dict.get("dropout_rate", 0)
        self.dropout_correlation = dropout_dict.get("dropout_correlation", 0)
        ...
        if dropout_method == "uniform":
            ...
            mean = dropout_method_params["mean"]
            std = dropout_method_params["std"]
