...
# def attack_zone(target_data_col, target_model, in_scores, out_scores, attack_hidden_size, attack_epochs, attack_lr, device='cuda'):
...
#     scores = attack_zone(target_data_col, target_model, in_scores, out_scores, attack_hidden_size, attack_epochs, attack_lr, device)
#     return scores