...
iid_weight_clients_new = {
    ...
    # server can have overlapping device ids with clients because
    # both are not used at the same time
    "device_ids": {"node_0": [0], "node_1": [0], "node_2": [1],"node_3": [1],"node_4": [2],"node_5": [2]},  

    # Learning setup
    "num_clients": 5, "samples_per_client": 500,
    "target_clients": 2, "similarity": "CosineSimilarity", #CosineSimilarity or EuclideanDistance
...
iid_l2c_clients_new = {
    ...
    # server can have overlapping device ids with clients because
    # both are not used at the same time
    "device_ids": {"node_0": [4], "node_1": [4], "node_2": [5],"node_3":[7],"node_4":[7]},  

    # Learning setup
    "num_clients": 4, "samples_per_client": 100, "alpha_lr": 0.01,
    "K_0": 1, "T_0": 2,
...
iid_dispfl_clients_new = {
    ...
    # Learning setup
    "num_clients": 4, "samples_per_client": 500, "cs":'random', 
    "neighbors":2, "active_rate": 0.8, #prob of active node
    "dense_ratio": 0.5,"erk_power_scale": 1, "anneal_factor":0.5,"dis_gradient_check": None,"static": None,
...
iid_defkt_clients_new = {
    ...
    "dense_ratio": 0.5,"erk_power_scale": 1,
