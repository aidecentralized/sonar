...
fedfomo = {
    ...
    "dump_dir": "./expt_dump/",
    "device_ids": get_device_ids(
        num_clients=fedfomo_client, num_client_per_gpu=10, available_gpus=[1, 2, 3]
    ),
    # Dataset params
...
fedcentral = {
    ...
    "dump_dir": "./expt_dump/",
    "device_ids": get_device_ids(
        num_clients=fedcentral_client, num_client_per_gpu=10, available_gpus=[1, 2, 3]
    ),
    # Dataset params
...
defkt = {
    ...
    "dump_dir": "./expt_dump/",
    "device_ids": get_device_ids(
        num_clients=defkt_client, num_client_per_gpu=10, available_gpus=[1, 2, 3]
    ),
    # Dataset params
...
fedass = {
    ...
    "device_ids": get_device_ids(
        ...
        num_client_per_gpu=10,
        available_gpus=[0, 1, 2, 3, 4, 5, 6, 7],
    ),
    # Dataset params
    "dset": get_domainnet_support(
        fedass_client
    ),  # get_fmow_support(fedran_client), # get_rxrx1_support(fedran_client), # get_domainnet_support(fedran_client), # get_camelyon17_support(fedran_client),
    "dpath": domainnet_dpath,
    "train_label_distribution": "iid",  # Either "iid", "non_iid" "support",
...
fedval = {
    ...
    "dump_dir": "./expt_dump/",
    "device_ids": get_device_ids(
        num_clients=fedval_client, num_client_per_gpu=3, available_gpus=[0, 1, 2, 3]
    ),
    "num_clients": fedval_client,
    # Dataset params
    "dset": get_camelyon17_support(
        fedval_client
    ),  # get_fmow_support(fedran_client), # get_rxrx1_support(fedran_client), # get_domainnet_support(fedran_client), # get_camelyon17_support(fedran_client),
    "dpath": wilds_dpath,
    "train_label_distribution": "iid",  # Either "iid", "non_iid" "support",
...
fedwe = {
    ...
    "dump_dir": "./expt_dump/",
    "device_ids": get_device_ids(
        num_clients=fedwe_client, num_client_per_gpu=10, available_gpus=[1, 2, 3]
    ),
    # Dataset params
...
swarm = {
    ...
    "dump_dir": "./expt_dump/",
    "device_ids": get_device_ids(
        num_clients=swarm_client, num_client_per_gpu=10, available_gpus=[1, 2, 3]
    ),
    # Dataset params
...
fedran = {
    ...
    "dump_dir": "./expt_dump/",
    "device_ids": get_device_ids(
        num_clients=fedran_client, num_client_per_gpu=10, available_gpus=[1, 2, 3]
    ),
    # Dataset params
    "dset": get_domainnet_support(
        fedran_client
...
fedring = {
    ...
    "dump_dir": "./expt_dump/",
    "device_ids": get_device_ids(
        num_clients=fedring_client, num_client_per_gpu=10, available_gpus=[1, 2, 3]
    ),
    # Dataset params
    "dset": get_domainnet_support(
        fedring_client
...
fedgrid = {
    ...
    "dump_dir": "./expt_dump/",
    "device_ids": get_device_ids(
        num_clients=fedgrid_client, num_client_per_gpu=10, available_gpus=[1, 2, 3]
    ),
    # Dataset params
    "dset": get_domainnet_support(
        fedgrid_client
...
fedtorus = {
    ...
    "dump_dir": "./expt_dump/",
    "device_ids": get_device_ids(
        num_clients=fedtorus_client, num_client_per_gpu=10, available_gpus=[1, 2, 3]
    ),
    # Dataset params
    "dset": get_domainnet_support(
        fedtorus_client
