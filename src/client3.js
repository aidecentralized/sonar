...
function chunkTensor(tensor, chunkSize) {
    ...
    for (let i = 0; i < numChunks; i++) {
      ...
      const chunkData = tensor.data.slice(start, end); // typedArray.slice or array.slice
    ...
    try {
      ...
      switch (data.type) {
        ...
        //   }
          ...
          //   const modelData = this.getLocalModelData();
          //   this.sendWeights(peerRank, modelData, data.request_id);
